...
class MASTERSviewerWindow:
    ...
    def __init__(self, Session = None):
        ...
        self.builder.add_from_file("MASTERSviewer.glade")                                 #
        ...
        #-------------------------------------------------------#
        #cmd.load('/home/labio/MastersWorkspace/TesteComMasters_Jan_27_2015/6_MonteCarlo/6_MonteCarlo.pdb')
        self.Visible  =  True
...
def main():
    dialog = MASTERSviewerWindow()
    dialog.run()
    #dialog.self.LoadFileInMASTERSViewer()
